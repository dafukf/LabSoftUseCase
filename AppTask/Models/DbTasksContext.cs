...
public partial class DbTasksContext : DbContext
{
    ...
    public DbTasksContext(
        DbContextOptions<DbTasksContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<Tarefa> Tarefas
    {
        get;
        set;
    } = null!;
    ...
    public virtual DbSet<Incidente> Incidentes
    {
        get;
        set;
    } = null!;
